...
const HandleDelte=async(id:string)=>{
    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          ...
          RateArr.map((ele,index)=>{
           return ( ele===1? <RatingFill key={index}/>:<RatingUnfill key={index} />);
            ...
            <span className="text-gray-600 ml-3">{Math.round(Rating)} Reviews</span>
          </span>
        ...
        <div className="flex">
          ...
          <button onClick={HandleUpdate} className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Edit</button>
          <button onClick={()=>HandleDelte(id)} className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Delete</button>
          <button onClick={()=>{setLike(!Like)}} className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
            {
                Like?( <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5 text-red-600" viewBox="0 0 24 24">
                <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"></path>
              </svg>):( <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
              <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"></path>
            </svg>)
            }
  ...
  {
    Isupdate?<UpdateProduct item={ProductData} setIsupdate={setIsupdate}/>:<></>
  }
</section>
    </>
  )
