  ...
  return (
    <>
      <div className="flex gap-4  p-4">
        <form
          id="dropdown"
          className="z-10 md:block hidden  w-56 p-3 border sticky top-10 flex-[0.35] h-screen bg-white rounded-lg shadow dark:bg-gray-700"
        >
          ...
          <ul className="space-y-2 text-sm" aria-labelledby="dropdownDefault">
            {Price.map((ele) => {
              return (
                <li key={ele.id} className="flex items-center">
                  <input
                    type="radio"
                    name="Price"
                    value={ele.id}
